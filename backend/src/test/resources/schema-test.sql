...
create table grooming_service_record (
    id bigint generated by default as identity primary key,
...
create table boarding_daily_record (
    id bigint generated by default as identity primary key,
...
create index idx_entry_token_value on entry_token(token_value);
create index idx_entry_token_pass on entry_token(pass_entitlement_id, status);
create index idx_entry_token_member_status on entry_token(member_id, status);
create index idx_entry_exit_member_park on entry_exit_record(member_id, store_id, occurred_at desc);
